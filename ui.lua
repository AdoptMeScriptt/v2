...
‎end
‎
‎local FR = createButton("FR", "FR", UDim2.new(0.202, 0, 0.354, 0), function()
...
‎end)
‎
‎local NFR = createButton("NFR", "NFR", UDim2.new(0.498, 0, 0.354, 0), function()
...
‎end)
‎
‎local MFR = createButton("MFR", "MFR", UDim2.new(0.797, 0, 0.354, 0), function()
...
‎local spawnCorner = Instance.new("UICorner", Spawn)
